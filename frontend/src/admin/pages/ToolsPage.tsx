  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-slate-600">Define tools (webhook, http_request, database_lookup) and attach them to agents for LLM tool-calling.</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="text-slate-900">Create tool</CardTitle>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="mt-1 w-full rounded-md border border-slate-300 bg-slate-50 px-3 py-2 font-mono text-sm text-slate-800"
        ...
        <Card>
          ...
          <CardContent>
            {items.length === 0 ? (
              <p className="text-sm text-slate-600">No tools yet. Create one to enable tool-calling for agents.</p>
            ) : (
