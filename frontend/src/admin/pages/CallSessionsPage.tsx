    ...
    <div className="space-y-6">
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Real-time session list (browser + phone later).</p>
        </div>
        <button
          type="button"
          onClick={load}
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-4">
        ...
        <div className="mt-3 flex gap-2">
          <button
            type="button"
            onClick={load}
            className="px-4 py-2 rounded-md bg-emerald-600 hover:bg-emerald-500 text-sm font-semibold text-white"
          >
            Apply filters
          </button>
          <button
            ...
            className="px-4 py-2 rounded-md bg-slate-800 hover:bg-slate-700 text-sm font-semibold text-slate-100"
          >
            Clear
          </button>
        </div>
              ...
              data.items.map((s) => (
                <tr key={s.id} className="border-t border-slate-900">
                  ...
                  <td className="px-4 py-3">
                    {s.agent ? (
                      <div>
                        <div className="font-semibold text-slate-100">{s.agent.name}</div>
